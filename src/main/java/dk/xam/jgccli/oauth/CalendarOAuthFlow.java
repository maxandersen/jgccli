...
import dk.xam.jgccli.exception.AuthorizationException;
...
public class CalendarOAuthFlow {
    ...
    public CalendarOAuthFlow(String clientId, String clientSecret) {
    ...
    private String startBrowserFlow() {
        ...
        try {
            ...
            System.out.println("Opening browser for Google Calendar authorization...");

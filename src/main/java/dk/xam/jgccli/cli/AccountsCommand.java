...
public class AccountsCommand {
    ...
    static class ListCommand implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            List<CalendarAccount> accounts = service.listAccounts();
            if (accounts.isEmpty()) {
    ...
    static class CredentialsCommand implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            if (list) {
                ...
                System.out.println("  jgccli accounts credentials <file.json> [--name <name>]");
                System.out.println("  jgccli accounts credentials --list");
                System.out.println("  jgccli accounts credentials --remove <name>");
                return 1;
            }
        }
